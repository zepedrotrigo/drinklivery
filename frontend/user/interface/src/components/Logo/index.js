            ...
            <svg width="100" height="100" viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <defs>
                    ...
                    <radialGradient id="paint2_diamond_10_2" cx="0" cy="0" r="1" gradientUnits="userSpaceOnUse" gradientTransform="translate(50.5 125.5) rotate(45) scale(53.033)">
                        <stop stop-color="#FFAF79" />
                        <stop offset="0.546875" stop-color="#FFAF79" stop-opacity="0.420168" />
                        <stop offset="0.822917" stop-color="#FFAF79" stop-opacity="0" />
                        <stop offset="0.989583" stop-color="#FFAF79" stop-opacity="0" />
                    </radialGradient>
                </defs>
            </svg>
