        ...
        <div className="container-4/5 mt-16">
            <div className="flex w-full justify-between">
                <div className="flex flex-col max-w-2xl self-center px-2">
                    ...
                    <button onClick={()=>navigate("/drinks")} className="bg-primary text-white text-2xl self-center px-8 py-4 rounded-full mt-10 hover:scale-[101%] active:scale-95">Check it out!</button>
                </div>
